...
<div class="modal fade" id="videoModal" tabindex="-1" role="dialog" aria-labelledby="videoModalLabel" aria-hidden="true">
    ...
    <section class="bg-white" id="deal" style="margin-top: 100px;"  >
      <div class="container" style="width: 80%; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1); font-family:Arial, Helvetica, sans-serif">
...
<p>f)Local caching of service data.In order to provide you with comprehensive products and services, WeTalk will obtain local storage rights on your device for product and service related storage and
...
<p>(5)The above third party SDK will collect your personal information according to the product functions. We will only authorize your corresponding personal information to the above third party plug-in when
...
People's Republic of China shall, in principle, be stored within the territory of the People's Republic of
...
practices), pose a risk to the legal rights of others, or are highly impractical (e.g., involving information
...
current state of the art to protect your information, take physical technical and administrative security
...
phone, push notification and other means. If it is difficult to inform individual information subjects one
...
relevant domestic regulations on the protection of personal information, we fulfill the responsibility of
...
attached to Article 11 of this Privacy Policy to express specific intention of rejection. We will handle it
...
regulations to protect your personal information, to ensure the security, confidentiality and integrity of
