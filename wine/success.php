...
<body>
    <div class="payment-form-body position-relative" data-spy="scroll" data-target=".navbar" data-offset="90">
        ...
        <div class="receipt-card">
            ...
            <p id="thank-message" class="subtitle"></p>
            <p class="subtitle">You’re all set for an intimate evening where wine appreciation, Chinese calligraphy, and
                philosophy blend in perfect harmony. We look forward to seeing you there!</p>
            ...
            <p class="support-text">
                For assistance, please contact WeTalk Support at +65 9758 2288
            </p>
        </div>
    </div>
