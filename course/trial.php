<style>
    .trial-class-container {
        background: url('../resources/img/course/trial-bg.png') no-repeat center center/cover;
        padding: 80px 20px;
        display: flex;
...
<div class="trial-class-container">
    <div class="trial-class-inner">
        ...
        <div class="trial-left">
            ...
            <ul class="check-list">
                <li>
                    <img src="../resources/img/course/check-trial.png" alt="Check">
            ...
            <img src="../resources/img/course/people.png" alt="People" class="trial-image people-img">
            <img src="../resources/img/course/zigzag.png" alt="Zigzag" class="trial-image zigzag-img">
        </div>
