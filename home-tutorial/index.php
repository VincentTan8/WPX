...
<style>
    ...
    .hero-section {
        ...
        height: 100vh;
        width: 100%;
        background-image: url('../resources/img/tutorial/tutorial-bg.png');
...
<body oncontextmenu="return false;" data-spy="scroll" data-target=".navbar" data-offset="90" class="position-relative">
    ...
    <div class="hero-content">
        <h1>
            <span id="hero-header">
                <span id="hero-title-1"></span> <span id="hero-title-2" style="color:#F2AE14;"></span>
                <span id="hero-title-3"></span>
            </span>
        </h1>
